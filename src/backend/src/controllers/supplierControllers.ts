...
class SupplierControllers {
    ...
    public createSupplier = async (request: RequestWithUser, response: Response) => {
        try {
            ...
            logControllers.logActions(request.user?.id, "Fornecedor registrado.", { id_fornecedor: supplier.id_fornecedor })
    ...
    public updateSupplier = async (request: RequestWithUser, response: Response) => {
        ...
        try {
            ...
            logControllers.logActions(request.user?.id, "Fornecedor editado.", { id_fornecedor: Number(id) })
    ...
    public deleteSupplier = async (request: RequestWithUser, response: Response) => {
        ...
        try {
            ...
            if (hasRelationships) {
                ...
                logControllers.logActions(request.user?.id, "Fornecedor deletado.", { id_fornecedor: Number(id) })
